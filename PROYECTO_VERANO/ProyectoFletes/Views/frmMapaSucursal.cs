...
{
    //alguna mamada para que se agregue
    public partial class frmMapaSucursal : Form
    {

        public frmCrearSucursal cs;
        GMarkerGoogle marker;
        GMapOverlay markerOverlay;
        public frmMapaSucursal()
        {
            InitializeComponent();
      
        }

        public frmMapaSucursal(frmCrearSucursal cs)
        {
            this.cs = cs;
            InitializeComponent();      
        }
...
;
        ...
        private void frmMapaSucursal_Load(object sender, EventArgs e)
        {
